"""
aegis.intent — Universal Intent Standard.

Before a payload hits the Aegis Firewall, it can be translated into a
...
::
    ...
    from aegis.intent import intent_from_evm_tx, intent_from_http_request
...
class NormalizedIntent:
    ...
    def to_aegis_payload(self) -> dict[str, Any]:
        """Convert to the dict format that ``AegisFirewall.evaluate()`` expects."""
