"""
aegis.oracles.price_feed — Pluggable price oracle with caching.
...
Usage::
    ...
    from aegis.oracles.price_feed import PriceFeed, PriceFeedConfig
...
logger = logging.getLogger("aegis.oracles")
